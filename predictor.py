...
all_conmats, all_guesses, fold_labels, used_models = run_ensemble_binary("games.csv", models, [], True)
keys, dataset, labels = dataset_array_form_from_csv("games.csv", [], True)
current_best_fn = [[], 0]
current = 0
improvement_count = 0
best_conmat = {}
